{
	"translatorID": "3f50abbc-7acc-4350-acd0-59cb77faf620",
	"translatorType": 2,
...
function doExport() {
	...
	while (item = Zotero.nextItem()) {
		...
		//Write the version urla nd version date here
		var versionInfo = "| versionurl = " + item.extra + "| versiondate = " + parseDate(item.extra);
